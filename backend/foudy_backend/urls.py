...
from core.views import health_check, health_database, health_redis, health_storage, health_system, health_email, health_version, verify_state
...
urlpatterns = [
    ...
    path('health/verify-state/', verify_state, name='verify_state'),
